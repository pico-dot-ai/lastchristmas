...
## Stack and runtime
- **UI**: Next.js 14 (App Router) + React + TypeScript; mobile-first; PWA installable.
...
- **Data/flags/logging**: Supabase Postgres + RLS; feature flags and debug logs currently active; auth/user tables are present but unused in UI.
- **External services**:
